        ...
        <div className="h-screen flex items-center justify-center bg-hero bg-cover bg-center">
            <div className="max-w-4xl mx-auto text-center space-y-8">
                ...
                <p className="text-lg text-muted-foreground leading-relaxed mb-8">
                    Desde la histórica Casa donde se declaró la Independencia
                    hasta los paisajes más espectaculares del noroeste
                    argentino, Tucumán combina patrimonio cultural con aventuras
                    únicas en cada rincón de la provincia.
                </p>
                ...
                <div className="grid sm:grid-cols-2 gap-6 mb-12">
                    <div className="bg-card border border-card-border rounded-lg p-6">
                        ...
                        <p className="text-muted-foreground">
                            Recorré los sitios donde se forjó la patria y
                            descubrí la arquitectura colonial que cuenta nuestra
                            historia.
                        </p>
                    </div>
                    ...
                    <div className="bg-card border border-card-border rounded-lg p-6">
                        ...
                        <p className="text-muted-foreground">
                            Desde parapente en Loma Bola hasta trekking en San
                            Javier, viví experiencias que elevan la adrenalina.
                        </p>
                    </div>
                </div> */}
